          ...
          <form role="form" method="POST" action="{{ route('jobs.update', $job->id) }}">
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <input type="text" maxlength="200" class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" name="title" id="title" placeholder="Título da Vaga" value="{{ $job->title ?? old('title') }}">
                @if ($errors->has('title'))
              ...
              <div class="form-group">
                ...
                <input type="number" max="10" min="1" class="form-control {{ $errors->has('beginning_semester') ? 'is-invalid' : '' }}" id="beginning_semester" name="beginning_semester" placeholder="Semestre de inicio" value="{{ $job->beginning_semester ?? old('beginning_semester') }}">
              ...
              <div class="form-group">
                ...
                <input type="number" max="10" min="1" class="form-control {{ $errors->has('final_semester') ? 'is-invalid' : '' }}" id="final_semester" name="final_semester" placeholder="Semestre de término" value="{{ $job->final_semester ?? old('final_semester') }}">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="url" maxlength="200" class="form-control {{ $errors->has('link') ? 'is-invalid' : '' }}" name="link" id="link" placeholder="Link da vaga" value="{{ $job->link ?? old('link') }}">
                    @if ($errors->has('link'))
                        <div class="invalid-feedback">
                            {{ $errors->first('link') }}
                        </div>
